...
#ifndef CARD_GAME_LOGGER_H
#define CARD_GAME_LOGGER_H
...
#define LOG_INIT_COUT() logger logd(std::cout, __PRETTY_FUNCTION__)
#define LOG_INIT_CERR() logger logd(std::cerr, __PRETTY_FUNCTION__)
#define LOG_INIT_CLOG() logger logd(std::clog, __PRETTY_FUNCTION__)
